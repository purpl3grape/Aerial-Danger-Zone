...
public class GenericSpawner : ObjectBase
{
    ...
    {
        var randomY = Random.Range(-Screen.height / 2 + m_prefabObj.Size / 2, Screen.height/ 2 - m_prefabObj.Size / 2);
        var spawnPos = new Vector2(Screen.width / 2 - Size / 2, randomY);
        GameObject obj = (GameObject)Instantiate(m_prefabObj.gameObject, Tr.parent, instantiateInWorldSpace: false);
        SetPositionOf(m_spawnType.Equals(SpawnType.Asteroid) ? obj.GetComponent<Asteroid>() : obj.GetComponent<Enemy>(), spawnPos);
    }
